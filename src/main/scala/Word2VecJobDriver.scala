...
object Word2VecJobDriver {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val tokenFilePath = "s3a://distributed-llm-bb-part-1/output/part-r-00000"
    ...
    conf.set("fs.defaultFS", "s3a://distributed-llm-bb-part-1") // Use s3a for better performance and compatibility
